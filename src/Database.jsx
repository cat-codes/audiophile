  ...
  categories: {
    headphones: {
      "XX99 MARK II headphones": {
        ...
        contents: [
          { name: "Headphone unit", qty: "1x" },
          { name: "Replacement Earcups", qty: "2x" },
          { name: "User Manual", qty: "1x" },
          { name: "3.5mm 5m Audio Cable", qty: "1x" },
          { name: "Travel Bag", qty: "1x" },
        ],
      },

      "XX99 MARK I headphones": {
        newProduct: false,
        img: "xx99-mark-i-headphones",
        price: "$ 1,750",
        description:
    ...
    speakers: {
      "ZX9 speaker": {
        ...
        contents: [
          { name: "Speaker unit", qty: "2x" },
          { name: "Speaker Cloth Panel", qty: "2x" },
          { name: "User Manual", qty: "1x" },
          { name: "3.5mm 10m Audio Cable", qty: "1x" },
          { name: "10m Optical Cable", qty: "1x" },
        ],
      },
      ...
      "ZX7 speaker": {
        ...
        contents: [
          ...
          { name: "Speaker Cloth Panel", qty: "2x" },
          { name: "User Manual", qty: "1x" },
          { name: "3.5mm 7.5m Audio Cable", qty: "1x" },
          { name: "7.5m Optical Cable", qty: "1x" },
        ],
      },
    },
    ...
    earphones: {
      "YX1 earphones": {
        ...
        contents: [
          { name: "Earphone unit", qty: "2x" },
          { name: "Multi-size Earplugs", qty: "6x" },
          { name: "User Manual", qty: "1x" },
          { name: "USB-C Charging Cable", qty: "1x" },
          { name: "Travel Pouch", qty: "1x" },
        ],
      },
    },
  },
